...
function build_model(; out, device)
  _model = Chain(
      ...
      Chain(
        ...
        SharedState(
          ...
          Chain(
            ...
            TimeDistributed(
              Chain(
                ConvTranspose((2, 2), 64=>64, stride=2, pad=SamePad(), bias=false, groups=64),
                BatchNorm(64, Flux.leakyrelu),                
        ...
        TimeDistributed(
          Chain(
            ConvTranspose((2, 2), 32=>32, stride=2, pad=SamePad(), bias=false, groups=32),
            BatchNorm(32, Flux.leakyrelu),
    ...
    TimeDistributed(
      Chain(
        ConvTranspose((2, 2), 16=>16, stride=2, pad=SamePad(), bias=false, groups=16),
        BatchNorm(16, Flux.leakyrelu),
        C3(16=>16, n=3, activation=Flux.leakyrelu),
