...
\authorcaratula{MARCO ANTONIO VELA RODRIGUEZ}

%Título en para el PIE DE PÁGINA (Agregar salto de línea de ser necesario)
\title{
  Desarrollo de un sistema basado en aprendizaje profundo para la predicción del desplazamiento y evolución de tormentas eléctricas en el territorio peruano
}
